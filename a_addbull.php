  ...
  <main>
    ...
    <div class="container pt-3 w-auto">
      ...
      <form method="POST">
        <?php
        echo <<<_END
              <br><br><br>內容標題：<input type="text" name="title" id="title">
              上架時間：<input type="date" name="time">
              下架時間：<input type="date" name="timedown">
              是否置頂：
              <select name="top">
              ...
              <br>
              <br>
              <textarea id="content" name="content" id="content"></textarea><br>
        ...
        if (isset($_POST["up"])) {
          $ins = "INSERT INTO `bulletin` (`b_title`,`b_content`,`b_time`,`b_timedown`,`b_settle`,`b_top`) VALUES ('" . $_POST["title"] . "','" . $_POST["content"] . "','" . $_POST["time"] . "','" . $_POST["timedown"] . "','1','" . $_POST["top"] . "')";
          $result = mysqli_query($db_link, $ins);
          echo "<script>alert('已公告');location.href='a_manbulletin.php';</script>";
        }
        if (isset($_POST["draft"])) {
          $date = date('Y-m-d');
          $link = @mysqli_connect("localhost", "root", "mysql", "work");
          if ($_POST["time"] != "" && $_POST["timedown"] != "")
            $ins = "INSERT INTO `bulletin` (`b_title`,`b_content`,`b_time`,`b_timedown`,`b_settle`,`b_top`) VALUES ('" . $_POST["title"] . "','" . $_POST["content"] . "','" . $_POST["time"] . "','" . $_POST["timedown"] . "','0','" . $_POST["top"] . "')";
          else
            $ins = "INSERT INTO `bulletin` (`b_title`,`b_content`,`b_time`,`b_timedown`,`b_settle`,`b_top`) VALUES ('" . $_POST["title"] . "','" . $_POST["content"] . "','0000-00-00','0000-00-00','0','" . $_POST["top"] . "')";
          $result = mysqli_query($db_link, $ins);
