...
if ($_GET['p_search'] == '') {
  ...
  $sql = "SELECT * FROM `suppliers` WHERE `su_name` LIKE '%" . $_GET['p_search'] . "%'";
}
...
<body>
 ...
 _END;
      ...
      while ($row = $result->fetch_assoc()) {
        echo '<form method="POST" action = "a_editsupplier.php"><tr>';
        echo "<td>" . $row["su_id"] . "</td>";
        echo "<td>" . $row["su_name"] . "</td>";
        echo "<td>" . $row["su_person"] . "</td>";
        echo "<td>" . $row["su_phone"] . "</td>";
        echo "<td>" . $row["su_address"] . "</td>";
        echo "<td>" . $row["su_numbers"] . "</td>";
        echo "<td><button name = 'uppost' class = 'btn'><i class = 'fas fa-pencil-alt'></i></button></td>";
        echo "<input type='hidden' name='n' value='" . $row["su_id"] . "'>";
        echo "</tr></form>";
      }
      echo "</tbody>";
      echo "</table><br>";
